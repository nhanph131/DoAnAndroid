...
public class ProfilePinViewModel extends ViewModel {
    ...
    public void getList(){
        ...
        String u = MainApplication.getUsername();
        MainApplication.getApiService()
                .getSavedPinByUserId(MainApplication.getUid())
                .enqueue(new Callback<>() {
                            ...
                            if (res != null) {
                                ...
                                if (pinResponses != null) {
                                    for (PinResponse pinResponse : pinResponses) {
                                        ...
                                        p.add(pin);
                                        Log.d("APISERVICE_SAVED_PIN", "onResponse: " + pinResponse.getTitle());
                                    }
                                }
                            }
                        }
                    ...
                    public void onFailure(Call<ResponseApi<List<PinResponse>>> call, Throwable t) {
                        ...
                        Log.d("APISERVICE_SAVED_PIN", "onFailure: " + t.getMessage() );
                    }
                });
    }
