...
public class CreatedPinFragment extends Fragment{
    private CreatedPinViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(CreatedPinViewModel.class);
    ...
    public CreatedPinFragment(int gridLayout, boolean pinInfoEnabled){
        super();
    ...
    private void initView(View view) {
        ...
        pinClickListener = new OnPinClickListener() {
            ...
            public void onPinClick(int position) {
                shareDataViewModel.setSelectedCreatedPin(pinList.get(position));
            }
